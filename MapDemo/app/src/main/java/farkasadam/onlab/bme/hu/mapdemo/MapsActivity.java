package farkasadam.onlab.bme.hu.mapdemo;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDistance.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Toast.makeText(MapsActivity.this, myLocation.distanceTo(clickLocation) + "", Toast.LENGTH_LONG).show();
                Toast.makeText(MapsActivity.this, routeDistance, Toast.LENGTH_LONG).show();
            }
        });

        clickLocation = new Location("ClickLocation");
    }
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
        ...
        protected List<List<HashMap<String, String>>> doInBackground(String... jsonData) {
            ...
            try {
                ...
                //Toast.makeText(MapsActivity.this, parser.getDistance(jObject) + "", Toast.LENGTH_LONG).show();
                routeDistance = parser.getDistance(jObject);
